...
class UpdateArticle extends React.Component {
    ...
    saveDataNew(e) {
        ...
        this.setState({ articles: this.state.articles ,article:{...article,id:"",title:"",content:""}});
    }
                        ...
                        <tbody>
                            {
                                this.state.articles.map((item)=>{
                                    return <tr>
                                        ...
                                        <td>{item.title}</td>
                                        <td>{item.content}</td>
                                        <td><button className='btn btn-primary' onClick={this.updateData}>Update</button></td>
                                        <td><button className='btn btn-danger' onClick={(e)=>this.deleteData(e)}>Delete</button></td>
                                    </tr>
                                })
                            }
                        </tbody>
